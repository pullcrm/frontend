...
export default Vue.extend({
  ...
  */
  ...
  render (createElement, { props, data, slots }) {
    ...
    if (props.leftIcon) {
      prepend = createElement('div', { class: 'ui-micro-text__prepend' }, [
    ...
    if (props.rightIcon) {
      append = createElement('div', { class: 'ui-micro-text__append' }, [
        createElement(UiIcon, {
          props: {
    ...
    if (append || prepend) {
      content = createElement('div', { class: 'ui-micro-text__content' }, content)
    }
